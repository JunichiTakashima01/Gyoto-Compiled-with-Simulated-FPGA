...
int main(int argc, char** argv) {
	...
	double christoffelResult3[64];
	double christoffelResult4[64];
	//printf("result0: %f\n", christoffelResult[1]);
	...
	int key3 = fgpainterface->send(inputtest3, postest2, 5);
	
	int key4 = fgpainterface->send(inputtest3, postest2, 5);
	fgpainterface->receive(christoffelResult4, key4);
	fgpainterface->receive(christoffelResult3, key3);
	printf("result3: %f\n", christoffelResult3[1]);
	printf("result4: %f\n", christoffelResult4[1]);
