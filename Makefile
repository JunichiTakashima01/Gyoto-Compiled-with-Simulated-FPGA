...
pkglibexecdir = $(libexecdir)/gyoto
...
ACLOCAL = ${SHELL} '/home/junichi/Gyoto/missing' aclocal-1.16
AEAE_CFLAGS = 
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
ARBLIB_CFLAGS = 
ARBLIB_LIBS =  -lflint-arb
AUTOCONF = ${SHELL} '/home/junichi/Gyoto/missing' autoconf
AUTOHEADER = ${SHELL} '/home/junichi/Gyoto/missing' autoheader
AUTOMAKE = ${SHELL} '/home/junichi/Gyoto/missing' automake-1.16
AWK = mawk
BIBTEX = 
BOOST_CPPFLAGS = 
BOOST_LDPATH = 
...
LORENELDFLAGS = 
LTLIBOBJS = 
MAKEINFO = ${SHELL} '/home/junichi/Gyoto/missing' makeinfo
MAKE_S = make -s
MANIFEST_TOOL = :
...
abs_builddir = /home/junichi/Gyoto
abs_srcdir = /home/junichi/Gyoto
...
install_sh = ${SHELL} /home/junichi/Gyoto/install-sh
...
mkdir_p = $(MKDIR_P)
mySUBDIRS = lib bin python yorick doc
oldincludedir = /usr/include
pdfdir = ${docdir}
pkg_cflags =  
pkg_libs =   -lflint-arb
pkg_requires =  udunits xerces-c eigen3 cfitsio
...
SUBDIRS = lib bin python yorick doc
all: config.h
...
include/GyotoConfig.h: include/stamp-h2
	@test -f $@ || rm -f include/stamp-h2
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) include/stamp-h2

include/stamp-h2: $(top_srcdir)/include/GyotoConfig.h.in $(top_builddir)/config.status
	@rm -f include/stamp-h2
	cd $(top_builddir) && $(SHELL) ./config.status include/GyotoConfig.h
...
yorick/Makefile: $(top_builddir)/config.status $(top_srcdir)/yorick/Makefile.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
yorick/stdplug/Makefile: $(top_builddir)/config.status $(top_srcdir)/yorick/stdplug/Makefile.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
yorick/gyoto.info: $(top_builddir)/config.status $(top_srcdir)/yorick/gyoto.info.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
yorick/yorick1: $(top_builddir)/config.status $(top_srcdir)/yorick/yorick1.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
